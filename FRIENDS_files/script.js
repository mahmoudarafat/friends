...
$(document).on('click', '.chat-link', function (e) {
    var whichChat = $(this).closest('a').attr('id');
    e.preventDefault();
    if (whichChat.indexOf("chatMessages") >= 0) {
        var currentChat = whichChat.substring(13);
        // console.log(currentChat);
        window.history.pushState("Details", "Title", '/chat/'+currentChat);
        $('#chat-section').load('chat/' + currentChat);
    }
});